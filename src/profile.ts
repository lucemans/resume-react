...
export const Profile = {
    bio: {
        'NL': 'Mijn naam is Luc, op het moment dat ik dit schrijf (29 December 2020), ben ik al 18 jaar op deze aardbodem, waarvan ik de laatste 9 jaar fanatiek aan het programmeren ben geweest. Ik ben een nieuwsgierig individu, die gek is op maken en creeren. In combinatie met een enorm doorzettingsvermogen ben ik tot elke taak in staat. Ik woon in Antwerpen, Belgie.',
